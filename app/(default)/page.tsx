          ...
          <div className="carousel w-full h-64 mt-3 gap-5">
            {games.map((game, idx) => (
              ...
              >
                ...
                <div
                  className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2 text-white">
...
export function MaterialSymbolsWallet(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path fill="#888888"
            d="M6 20q-1.65 0-2.825-1.175Q2 17.65 2 16V8q0-1.65 1.175-2.825Q4.35 4 6 4h12q1.65 0 2.825 1.175Q22 6.35 22 8v8q0 1.65-1.175 2.825Q19.65 20 18 20ZM6 8h12q.55 0 1.05.125t.95.4V8q0-.825-.587-1.412Q18.825 6 18 6H6q-.825 0-1.412.588Q4 7.175 4 8v.525q.45-.275.95-.4Q5.45 8 6 8Zm-1.85 3.25l11.125 2.7q.225.05.45 0t.425-.2l3.475-2.9q-.275-.375-.7-.612Q18.5 10 18 10H6q-.65 0-1.137.337q-.488.338-.713.913Z"></path>
    </svg>
  )
}
